...
export const RFM_SEGMENT_COLORS: Record<string, { bg: string; text: string; badge: string }> = {
  ...
  "Clientes Fieles":       { bg: "bg-blue-100",   text: "text-blue-800",   badge: "bg-blue-100 text-blue-800"    },
  "Potenciales Fieles":    { bg: "bg-indigo-100", text: "text-indigo-800", badge: "bg-indigo-100 text-indigo-800" },
  "Nuevos Clientes":       { bg: "bg-cyan-100",   text: "text-cyan-800",   badge: "bg-cyan-100 text-cyan-800"    },
  "Clientes Prometedores": { bg: "bg-teal-100",   text: "text-teal-800",   badge: "bg-teal-100 text-teal-800"    },
  "Requieren Atención":    { bg: "bg-yellow-100", text: "text-yellow-800", badge: "bg-yellow-100 text-yellow-800" },
  "A Punto de Inactivarse":{ bg: "bg-orange-100", text: "text-orange-800", badge: "bg-orange-100 text-orange-800" },
  "En Riesgo de Perderse": { bg: "bg-red-100",    text: "text-red-800",    badge: "bg-red-100 text-red-800"      },
  "No Puedes Perderlos":   { bg: "bg-rose-100",   text: "text-rose-800",   badge: "bg-rose-100 text-rose-800"    },
